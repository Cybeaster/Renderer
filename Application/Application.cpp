...
void OApplication::InitRenderer()
{
	...
	OTestLightning lightning(brickTexture, earthTexture, GetShaderLocalPathWith(BasicPhongShadingSpotlight), renderer, GetShaderLocalPathWith(BasicShadowShader));
